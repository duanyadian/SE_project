...
class Testpy(object):  # 类命名规则，以Test开头
    def test_math(self):  # 在类中称为方法，方法命名规则与函数一样，以test_开头
        assert 1 + 2 == 3
...
if __name__ == '__main__':
    pytest.main(["-sv", "test_learn.py"])  # 通过main函数执行命令
...
# pytest -vs test_learn.py::Testpy::test_math   只执行文件中Testpy类下的test_math方法
# pytest -vs test_learn.py::test_func           只执行文件中test_func函数